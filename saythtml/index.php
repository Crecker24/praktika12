        ...
        <section class="welcome">
            <div class="container">
                <h1 class="welcome-title">
                    CodeNova - Трансформируй идеи в новые возможности
                </h1>
                <h3 class="welcome-description">
                    Полный цикл программной разработки: с концепции до релиза
                </h3>
...
?>
                        ...
                        <div class="consultation-form-group">
                            <label for="datatime" class="consultation-form-label">Дата</label>
                            <input type="date" id="datatime" name="datatime" class="consultation-form-input" required>
                        </div>
